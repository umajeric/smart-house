...
public class TriToggleButton extends Button {
	...
	private void setButtonText() {
		switch (_state) {
		case -1:
			this.setBackgroundResource(R.drawable.icon_switch);
			break;
		case 0:
			this.setBackgroundResource(R.drawable.icon_off);
			break;
		case 1:
			this.setBackgroundResource(R.drawable.icon_on);
			break;
		default:
			this.setBackgroundResource(R.drawable.icon_switch); // Should never happen, but just in case
			break;
		}
	}
}